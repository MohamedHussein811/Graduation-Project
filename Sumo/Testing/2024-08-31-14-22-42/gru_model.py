...
from tensorflow.keras.layers import Dense, Dropout, BatchNormalization, GRU, Bidirectional, Input
...
if df_cleaned.empty:
    ...
    model.add(Bidirectional(GRU(64)))  # Option: Use GRU(64) for faster processing
    ...
    # Save the model
    model.save('Models/exit_edge_gru.h5')
